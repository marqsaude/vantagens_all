<?php
class Pagseguro_PagSeguro{
	private $email         = "financeiroqsaudevantagens@gmail.com";
	//private $email         = "tabx.php@gmail.com";
	//private $token = "18DCBDB9D390478DA46640EEA042A3F8"; //Oficial SandBox
	//private $token = "8F7DB311DEE44136AC49452B066224F8"; //Tony SandBox
	private $token = "8D77CFD53C9D4886A20A1FBBD40A6349"; //Oficial
	//private $token = "5AFFF5246ABB43D8B9615C7194AABE82"; //Tony

	private $url_retorno   = "http://www.marqsaudevantagens.com/pag-seguro/retorno";
	...
	*/
	...
	public function getCodeByNotificationCode($code){
