...
abstract class Util_NumeroExtenso {
    ...
    public static function convertNumberToWords($number) {
        ...
        switch (true) {
            ...
            default:
                ...
                if ($baseUnit == 1000) {
                    $string = self::convertNumberToWords($numBaseUnits) . ' ' . $dictionary[1000];
                } elseif ($numBaseUnits == 1) {
                    $string = self::convertNumberToWords($numBaseUnits) . ' ' . $dictionary[$baseUnit][0];
                } else {
                    $string = self::convertNumberToWords($numBaseUnits) . ' ' . $dictionary[$baseUnit][1];
                }
                if ($remainder) {
