...
function mountHtmlDependentes(){
    ...
    htmlDependentes += '                <button type="submit" onclick="comeBack();" style="float:left;" class="btn btn-primary btn-large pull-right" id="voltar-cliente-tipo-vantagem"><< Voltar</button>';
    htmlDependentes += '            </div>';
    htmlDependentes += '            <div class="span4">';
    htmlDependentes += '                <button type="submit" style="float:right;" id="enviar-contrato" class="btn btn-primary btn-large pull-right">Próximo >></button>';
    htmlDependentes += '            </div>';
    htmlDependentes += '            <div class="span2"></div>';
    htmlDependentes += '        </div>';
    htmlDependentes += '    </div>';
