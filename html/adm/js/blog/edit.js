...
function submitEditBlog(){
    jQuery("#editBlog").submit();
}

function validaEditBlog(obj){
    var html = "";
    ...
    if(html!=""){
        ...
        var array = {"nm_blog": obj.nm_blog.value, "tx_blog": obj.tx_blog.value, "tp_visualizacao": obj.tp_visualizacao.value, "lk_img_blog": obj.lk_img_blog.value, "co_seq_blog": obj.co_seq_blog.value, "procedimentos": procedimentos};
        ajaxPost(funcaoEditBlog, array, "/blog/ajax-edit/", "/admin");
    }
    return false;
}

var funcaoEditBlog = function(json){
    if(json!=null){
        alert("Editado com sucesso!");
        window.location.href = getUrlController() + "/admin/blog/index";
    }
};
