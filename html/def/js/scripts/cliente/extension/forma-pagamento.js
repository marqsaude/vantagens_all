...
function mountHtmlFormaPagamento(){
    ...
    htmlFormaPagamento += '         <i class="icon fa-angle-down select-fa"></i>';
...
function htmlBtns(){
    ...
    html += '           <button type="submit" onclick="comeBackFormaPagamento();" style="float:left;" class="pull-right btn-contato" id="voltar-dependentes"><< Voltar</button>';
    html += '       </div>';
        ...
        if(jQuery(obj).find(":selected").val()=="1" || jQuery(obj).find(":selected").val()==1){
            ...
            jQuery.each( dataFormaPagamento, function( key, value ) {
                //if(value.co_seq_forma_pagamento==jQuery(obj).find(":selected").val()){
                    ...
                    html += '   <i class="icon fa-angle-down select-fa"></i>';
            ...
            getHtmlBoletoSicoob();
            jQuery("#enviar-forma-pagamento").html('<button type="submit" onclick="submitBoletoSicoob();" id="btn-fim" class="pull-right btn-contato">Gerar Boleto(s)</button>');
            ...
            htmlFormaPagamento += '</div>';
            jQuery("#price-vantagem").html(htmlFormaPagamento);
            jQuery("#enviar-forma-pagamento").html('<button type="submit" onclick="goPagSeguro();" id="btn-fim" class="pull-right btn-contato">PagSeguro</button>');
            jQuery("#main").css("height", "587px");
