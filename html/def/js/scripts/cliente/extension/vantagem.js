...
function mountHtmlUmTipoVantagem(){
    ...
    htmlUmTipoVantagem += '           <button type="submit" onclick="comeBack();" style="float:left;" class="pull-right btn-contato" id="voltar-cliente-tipo-vantagem"><< Voltar</button>';
    htmlUmTipoVantagem += '       </div>';
    htmlUmTipoVantagem += '       <div class="span4">';
    htmlUmTipoVantagem += '           <button type="submit" style="float:right;" id="enviar-contrato" class="pull-right btn-contato">Próximo >></button>';
    htmlUmTipoVantagem += '       </div>';
    htmlUmTipoVantagem += '       <div class="span2"></div>';
    htmlUmTipoVantagem += '   </div>';
...
function mountHtmlTipoVantagem(){
    ...
    htmlTipoVantagem += '           <i class="icon fa-angle-down select-fa"></i>';
    ...
    htmlTipoVantagem += '           <button type="submit" onclick="comeBack();" class="pull-right btn-contato" id="voltar-cliente-tipo-vantagem"><< Voltar</button>';
    htmlTipoVantagem += '       </div>';
    htmlTipoVantagem += '       <div class="span4">';
    htmlTipoVantagem += '           <button type="submit" id="enviar-contrato" class="pull-right btn-contato">Próximo >></button>';
    htmlTipoVantagem += '       </div>';
    htmlTipoVantagem += '       <div class="span2"></div>';
    htmlTipoVantagem += '   </div>';
